...
\draw [arrow, gray] ([xshift=-30pt]alimentacion.south) -- ([xshift=-30pt]fsm.north);
...
\draw [arrow, blue] ([xshift=20pt]fsm.north) |- node[above] {\shortstack{Displays ON/OFF \\ Reiniciar Cuenta}} (despliegue.west);
