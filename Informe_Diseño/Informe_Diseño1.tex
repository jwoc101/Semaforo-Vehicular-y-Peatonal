...
Se utilizaron tres temporizadores NE555 configurados en modo astable. Esta configuración permite generar una onda cuadrada de forma autónoma cuya frecuencia depende de los valores de $R_a$, $R_b$ y el capacitor de temporización $C$, según la ecuación:
...
La polarización se realiza con un divisor de tensión en la base para establecer el punto Q centrado en $V_{CE} \approx V_{CC}/2$. Los componentes se muestran en la Tabla~\ref{tab:emisor_comun}.
...
La configuración de colector común con TIP31C amplifica la corriente para excitar el parlante, presentando alta ganancia de corriente ($h_{FE} \geq 25$ con $I_C = 1\,\text{A}$ según datasheet) y baja impedancia de salida. Los componentes se listan en la Tabla~\ref{tab:seguidor_emisor}.
