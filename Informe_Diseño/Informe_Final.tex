...
Por ultimo en el apartado de apéndice se encuentra la imagen del diagrama del circuito completo de las simulaciones.
...
\section{Circuito prototipado}

Después del diseño en simulación, cada subsistema fue prototipado, lo que permitió detectar e implementar las modificaciones descritas en las secciones anteriores antes de pasar a la fabricación final, y se puede observar en las Figuras~\ref{fig:proto_fuente}--\ref{fig:proto_audio}, que muestran el montaje físico de cada sistema. Además, un dato importante a aclarar es que, como las imágenes son del resultado final de los circuitos, están agrupadas de manera estratégica para montarlos en la maqueta.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{proto_fuente.jpeg}
    \caption{Prototipo del subsistema de alimentación antes de crear la PCB.}
    \label{fig:proto_fuente}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{proto_tc_display.jpeg}
    \caption{Prototipo del subsistema de despliegue y generación de la señal $T_C$.}
    \label{fig:proto_tc_display}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{proto_fsm_contador_boton.jpeg}
    \caption{Prototipo de la máquina de estados, con el contador y el circuito del botón.}
    \label{fig:proto_fsm_contador_boton}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{proto_audio.jpeg}
    \caption{Prototipo del subsistema de audio.}
    \label{fig:proto_audio}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Diagrama_pcb.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pcb_eagle.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pcb_antes.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pcb_despues1.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pcb_despues2.jpg}
...
\end{thebibliography}
\appendix
\section{Diagrama esquemático completo}

Al final de la pagina esta el diagrama del circuito completo.

\begin{landscape}
\begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth]{Diagrama_completo_recortado.pdf}
    \caption{Diagrama esquemático completo del sistema.}
